...
- for free-first mode provide one or more of `GEMINI_API_KEY`, `GROQ_API_KEY`, `GITHUB_MODELS_API_KEY`
...
LLM_PROVIDER=auto
LLM_PROVIDER_ORDER=github_models,groq,gemini,openrouter,openai
GEMINI_API_KEY=
GROQ_API_KEY=
